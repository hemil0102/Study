...
/* ⭐️The Basics
     ...
     2️⃣ Swift provides its own versions of all fundamental C and Objective-C types.
        (Int, Double, Float, Bool, String, Array, Set, Dictionary)
...
var harryHeight = 178  //Declare a new variable called harryHeight, and give it an initial value of 0

// ❓ 왜 상수는 그냥 값을 준다하고 변수는 초기 값을 준다고 하는 것일까? (앗아아 깊게 들어가면 안돼 \(ㅇㅁㅇ)/)
